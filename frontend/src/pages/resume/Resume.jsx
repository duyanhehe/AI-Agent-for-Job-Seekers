                ...
                {openMenu === cv.cv_id && (
                  <div className="absolute right-0 mt-2 w-48 bg-white rounded shadow-md z-10">
                    <button
                      ...
                      className={`flex items-center gap-2 block w-full text-left px-4 py-2 ${
                        cvList.length <= 1
                    ...
                    <button
                      ...
                      className="flex items-center gap-2 block w-full text-left px-4 py-2 text-red-500 hover:bg-gray-100"
                    >
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        fill="none"
